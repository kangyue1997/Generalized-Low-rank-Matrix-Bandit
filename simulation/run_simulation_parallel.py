...
#simulation for one case: d=10 ,r=2 ,Theta is generated by sum of otter product of two vectors.
d1, d2, r = 10, 10, 2
d = 10
p = d1*d2
dom_d = r*(d1+d2-r)
...
if not context:
    ...
    df.to_csv('../saved_result/d10_r2_arm1000.csv')
